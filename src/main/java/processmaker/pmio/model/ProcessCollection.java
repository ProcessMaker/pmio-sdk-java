 ...
 */
@ApiModel(description = "JSON API response with a collection of the processes in an array")
...
public class ProcessCollection   {
  ...
  public ProcessCollection data(List<Process> data) {
    this.data = data;
    return this;
  }

  public ProcessCollection addDataItem(Process dataItem) {
  ...
  **/
  ...
  public ProcessCollection meta(Meta meta) {
    this.meta = meta;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.data, processCollection.data) &&
        Objects.equals(this.meta, processCollection.meta);
  }
