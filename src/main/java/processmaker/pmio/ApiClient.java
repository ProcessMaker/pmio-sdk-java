...
import processmaker.pmio.auth.Authentication;
import processmaker.pmio.auth.HttpBasicAuth;
import processmaker.pmio.auth.ApiKeyAuth;
import processmaker.pmio.auth.OAuth;
...
public class ApiClient {
    ...
    private String basePath = "https://CHANGEME.api.processmaker.io/api/v1";
    ...
    public ApiClient() {
        ...
        authentications.put("PasswordGrant", new OAuth());
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://CHANGEME.api.processmaker.io/api/v1
